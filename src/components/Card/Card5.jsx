...
const Card5 = ({ title}) =>  (
  ...
  <div className="p-4">
    ...
    <p className="py-8 font-hirakakupro">虎ノ門駅を出てすぐ、虎ノ門交差点付近に鎮座するこの銅像。 これ、なんだかお分かりでしょうか？ そう、猫です。というのは嘘で予想どおり、虎です(笑) 虎ノ門だけに虎の銅像なんです！ そもそもどうして、ここの地名が「虎ノ門」なのか気になりませんか？</p>
  </div>
</div>
